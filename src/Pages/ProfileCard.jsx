...
const ProfileCard = () => {
  ...
  return (
    <div>
      <div className="h-screen dark:bg-gray-700 bg-gray-200 pt-30">

        <div className="max-w-sm mx-auto bg-white dark:bg-gray-900 rounded-lg overflow-hidden shadow-lg">
          <div className="border-b px-4 pb-6">
            <div className="text-center my-4">https
              <img className="h-32 w-32 rounded-full border-4 border-white dark:border-gray-800 mx-auto my-4" src="https://www.svgrepo.com/show/12742/avatar.svg" alt />
              <div className="py-2">
              ...
              <div className="inline-flex text-gray-700 dark:text-gray-300 items-center">
                <span className=' bi bi-envelope-arrow-down'></span>&nbsp;
                Email: {user.email}
              </div>
            </div>
            <div className="flex gap-2 px-2">
              <button className="flex-1 rounded-full bg-blue-600 dark:bg-blue-800 text-white dark:text-white antialiased font-bold hover:bg-blue-800 dark:hover:bg-blue-900 px-4 py-2" >
                Favourites <span className=' bi bi-heart-fill text-red-600'></span>
              </button>
              <button className="flex-1 rounded-full border-2 border-gray-400 dark:border-gray-700 font-semibold text-black dark:text-white px-4 py-2" onClick={handlelogout}>
                Logout
              </button>
            </div>
          </div>
